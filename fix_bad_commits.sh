...
# (rjl@applied-math.org or joe.loughry@stx.ox.ac.uk) instead of "jloughry"
# (joe.loughry@gmail.com) back before I established my current GitHub account.
# I don't want to lose the history of those changes, so reset them to the
# correct identity so they get credited properly in `git blame` from now on.
#
